...
## rpi image shrinker. This script can shrink multi partition images.
## usage sudo ./pishrink.sh <image name>
## source: https://raw.githubusercontent.com/Drewsif/PiShrink/master/pishrink.sh
